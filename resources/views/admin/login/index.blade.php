<!-- kế thừa layout-login blade -->
@extends('admin.layout-login')

<!-- truyền biến sang view cha(view đc kế thừa) -->
@section('title', 'admin')
                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    ...
                                    <form class="user" method="post" action="{{ route('admin.handle.login') }}">
                                        <!-- render token trong input hidden vì method post -->
                                        @csrf
